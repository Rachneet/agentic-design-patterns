...
def main():
    ...
    try:
        ...
        print("   Powered by an LLM & ChromaDB")
        print("=" * 55)
        ...
        collection = create_similarity_search_collection(
            ...
            {'description': 'Enhanced RAG chatbot with LLM integration'}
        )
...
Response:'''
        ...
        generated_response = chat.invoke(prompt)
        
        # Extract the generated text
        if generated_response.content:
            response_text = generated_response.content
...
Comparison:'''
        ...
        generated_response = chat.invoke(comparison_prompt)
        
        if generated_response.content:
            return generated_response.content.strip()
        else:
...
def show_enhanced_rag_help():
    ...
    print("=" * 45)
    print("🧠 This chatbot uses an LLM to understand your")
